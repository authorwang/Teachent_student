...
public class InitialListListAdapter extends BaseAdapter {
...
//    private int[] icons;
    ...
    public InitialListListAdapter(Context context, String[] titles, String[] texts){
...
//            }else{
                convertView = inflater.inflate(R.layout.initial_list_list_item,null);
//            }
            vh = new ViewHolder();
//            if(position==0){//若为头像
//                vh.iv_avatar = (ImageView) convertView.findViewById(R.id.iv_frag_information_avatar);
//            }else {
                vh.tv_title = (TextView) convertView.findViewById(R.id.tv_activity_initial_list_id);
                vh.tv_text = (TextView) convertView.findViewById(R.id.tv_activity_initial_list_name);
//            }
